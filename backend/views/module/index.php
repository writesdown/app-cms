    ...
    <div class="module-index">
        ...
        <div class="form-inline grid-nav" role="form">
            <div class="form-group">
                ...
                <?= Html::a(Yii::t('writesdown', 'Add New Module'), ['create'], ['class' => 'btn btn-flat btn-primary']) ?>
                <?= Html::button(Html::tag('i', '', ['class' => 'fa fa-search']), ['class' => 'btn btn-flat btn-info', "data-toggle" => "collapse", "data-target" => "#module-search"]); ?>
            </div>
        </div>
