...
<div class="options-form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <div class="checkbox">
                <?= Html::label(
                    Html::checkbox(
                        'Option[default_comment_status][option_value]',
                        $model->default_comment_status->option_value === 'open' ? true : false, [
                            'uncheck' => 'close',
                            'value'   => 'open',
                        ]
            ...
            <p class="description">
                ( <?= Yii::t('writesdown', 'These settings may be overridden for individual articles.') ?> )
            </p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <div class="checkbox">
                <?= Html::label(
                    Html::checkbox(
                        'Option[require_name_email][option_value]',
                        $model->require_name_email->option_value,
                        ['uncheck' => 0]
                ...
                <?= Html::label(
                    Html::checkbox(
                        'Option[comment_registration][option_value]',
                        $model->comment_registration->option_value,
                        ['uncheck' => 0]
                ...
                <?= Html::label(
                    Html::checkbox(
                        'Option[close_comments_for_old_posts][option_value]',
                        $model->close_comments_for_old_posts->option_value,
                        ['uncheck' => 0]
                ...
                <?= Html::input(
                    'number',
                    'Option[close_comments_days_old][option_value]',
                    $model->close_comments_days_old->option_value, [
                        'min'   => 0,
                        'step'  => 1,
                        'style' => 'width: 50px',
                    ]
                ...
                <?= Html::label(Yii::t('writesdown', ' days'), null, ['style' => 'padding-left: 0']) ?><br/>

                <?= Html::label(
                    Html::checkbox(
                        'Option[thread_comments][option_value]',
                        $model->thread_comments->option_value,
                        ['uncheck' => 0]
                ...
                <?= Html::input(
                    'number',
                    'Option[thread_comments_depth][option_value]',
                    $model->thread_comments_depth->option_value,
                    ['min' => 0, 'step' => 1, 'style' => 'width: 50px']
                ) ?>

                <?= Html::label(Yii::t('writesdown', 'levels deep'), null, ['style' => 'padding-left: 0']) ?><br/>

                <?= Html::label(
                    Html::checkbox(
                        'Option[page_comments][option_value]',
                        $model->page_comments->option_value,
                        ['uncheck' => 0]
                ...
                <?= Html::input(
                    'number',
                    'Option[comments_per_page][option_value]',
                    $model->comments_per_page->option_value,
                    ['min' => 0, 'step' => 1, 'style' => 'width: 50px', ]
                ) ?>

                <?= Html::label(
                    Yii::t('writesdown', 'top level comments per page and the'),
                    null,
                    ['style' => 'padding-left: 0']
                ) ?>

                <?= Html::dropDownList(
                    'Option[default_comments_page][option_value]',
                    $model->default_comments_page->option_value,
                    ['newest' => 'last', 'oldest' => 'first']
                ) ?>

                <?= Html::label(
                    Yii::t('writesdown', 'page displayed by default Comments should be displayed with the'),
                    null,
                    ['style' => 'padding-left: 0']
                ) ?>

                <?= Html::dropDownList(
                    'Option[comment_order][option_value]',
                    $model->comment_order->option_value,
                    ['asc' => 'older', 'desc' => 'newer']
                ) ?>

                <?= Html::label(
                    Yii::t('writesdown', 'comments at the top of each page'),
                    null,
                    ['style' => 'padding-left: 0']
                ) ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <div class="checkbox">
                <?= Html::label(
                    Html::checkbox(
                        'Option[comments_notify][option_value]',
                        $model->comments_notify->option_value,
                        ['uncheck' => 0]
                ...
                <?= Html::label(
                    Html::checkbox(
                        'Option[moderation_notify][option_value]',
                        $model->moderation_notify->option_value,
                        ['uncheck' => 0]
    ...
    <div class="form-group">
        <?= Html::label(
            Yii::t('writesdown', 'Before a comment appears'),
            null,
        ...
        <div class="col-sm-7">
            <div class="checkbox">
                <?= Html::label(
                    Html::checkbox(
                        'Option[comment_moderation][option_value]',
                        $model->comment_moderation->option_value,
                        ['uncheck' => 0]
                ...
                <?= Html::label(
                    Html::checkbox(
                        'Option[comment_whitelist][option_value]',
                        $model->comment_whitelist->option_value,
                        ['uncheck' => 0]
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <div class="checkbox">
                <?= Html::label(
                    Html::checkbox(
                        'Option[show_avatars][option_value]',
                        $model->show_avatars->option_value,
                        ['uncheck' => 0]
