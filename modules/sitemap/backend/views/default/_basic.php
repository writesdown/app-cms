...
<div id="sitemap-basic-option" class="sitemap-default-index-basic tab-pane active">
    ...
    <div class="form-group checkbox">
        ...
        <p>
            <?= Yii::t('sitemap', 'You can find your XML Sitemap here: {sitemapUrl}', [
                'sitemapUrl' => Html::a(Yii::t('sitemap', 'XML SITEMAP'), Yii::$app->urlManagerFront->createUrl([
    ...
    <p>
        <?= Yii::t('sitemap', 'Please enter the maximum number of entries per sitemap page (defaults to 1000,
    ...
    <div class="form-group">
        ...
        <?= Html::textInput('Option[option_value][entries_per_page]', $value, [
            'id' => 'sitemap-entries_per_page']);
        ?>
    </div>
</div>
