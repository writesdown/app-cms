    ...
    <?php foreach ($taxonomies as $taxonomy): ?>
        ...
        <div class="form-group">
            ...
            && $option['taxonomy'][$taxonomy->id]['priority']
                ...
                : null;
            ?>
            <?= Html::label(Yii::t('sitemap', 'Priority:'), 'option-option_value-taxonomies-priority-' . $taxonomy->id,
                ['class' => 'form-label']) ?>
        ...
        <div class="form-group">
            ...
            <?= Html::dropDownList("Option[option_value][taxonomy][$taxonomy->id][changefreq]", $selection,
                $changeFreq, [
                    'class' => 'form-control',
