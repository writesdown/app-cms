...
<div id="sitemap-media-option" class="sitemap-default-index-media tab-pane">
    ...
    <div class="form-group">
        ...
        <?= Html::label(Yii::t('sitemap', 'Priority:'), 'option-option_value-media-priority', [
            'class' => 'form-label',
        ]) ?>
        <?= Html::dropDownList('Option[option_value][media][priority]', $selection, $priority, [
            'class' => 'form-control',
        ]) ?>
    ...
    <div class="form-group">
        ...
        <?= Html::label(Yii::t('sitemap', 'Change Frequency:'), 'option-option_value-media-changefreq', [
            'class' => 'form-label',
        ]) ?>
        <?= Html::dropDownList('Option[option_value][media][changefreq]', $selection, $changeFreq, [
            'class' => 'form-control',
        ]) ?>
