    ...
    <?php foreach ($postTypes as $postType): ?>
        ...
        <div class="form-group checkbox">
            ...
            <label>
                ...
                && $option['post_type'][$postType->id]['enable']
                    ...
                    : false;
                ?>
                <?= Html::checkbox("Option[option_value][post_type][$postType->id][enable]", $checked,
                    ['value' => 1]) ?>
        ...
        <div class="form-group">
            ...
            && $option['post_type'][$postType->id]['priority']
                ...
                : null;
            ?>
            <?= Html::label(Yii::t('sitemap', 'Priority:'), 'option-option_value-post-types-priority-' . $postType->id,
                ['class' => 'form-label']) ?>
        ...
        <div class="form-group">
            ...
            && $option['post_type'][$postType->id]['changefreq']
                ...
                : null;
            ?>
            <?= Html::label(Yii::t('sitemap', 'Change Frequency:'),
                'option-option_value-post-types-changefreq-' . $postType->id, ['class' => 'form-label']) ?>
            <?= Html::dropDownList("Option[option_value][post_type][$postType->id][changefreq]", $selection,
                $changeFreq, [
                    'class' => 'form-control',
