    ...
    <xsl:template match="/">
        ...
        <div id="content">
            ...
            <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &gt; 0">
                <p class="expl">
                    <?= Yii::t('writesdown', 'This XML Sitemap Index file contains {countSitemap} sitemaps.', [
            ...
            <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
                <p class="expl">
                    <?= Yii::t('writesdown', 'This XML Sitemap contains {countSitemap} URLs', [
                        'countSitemap' => '<xsl:value-of select="count(sitemap:urlset/sitemap:url)"/>',
                    ]) ?>
                </p>

                <p class="expl"><?= Html::a(Yii::t('writesdown', '&#8593; Sitemap Index'),
